...
class FilterSet(object):
    def __init__(self, filter, mask=None):
        """
        This class handles the optical filter functionality. It is build around
        speclite: http://speclite.readthedocs.io/en/latest/
        ...
        # to return values from the filters (speclite appends 's' to the end of sequence
        # calls)
    ...
    def _calculate_fwhm(self):
        """Calculate the FWHM of the filters :return:"""
    ...
    def set_model(self, differential_flux):
        ...
        Not that speclite considers a differential flux to be in units
        of erg/s/cm2/lambda so we must convert astromodels into the
        proper units (using astropy units!)
        """
    ...
    def ab_magnitudes(self):
        ...
        magnitude system :return: np.ndarray of ab magnitudes."""
