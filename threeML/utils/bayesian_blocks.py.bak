...
def bayesian_blocks(tt, ttstart, ttstop, p0, bkgIntegralDistr=None):
    """
    ...
    :param bkgIntegralDistr: (default: None) If given, the algorithm account for the presence of the background and
    ...
    # eq. 21 from Scargle 2012
    priors = 4 - np.log(73.53 * p0 * np.power(np.arange(1, N + 1), -0.478))  # type: np.ndarray
