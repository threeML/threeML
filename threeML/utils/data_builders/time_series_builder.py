...
class TimeSeriesBuilder(object):
    ...
    @classmethod
    def from_konus_pha(cls, name, pha_file, rsp_file, arf_file, restore_background=None,
                                trigger_time=None, poly_order=-1, verbose=True, sum_channels=[]):
        """
        ...
        spectrum_set = PHASpectrumSet(pha_file, rsp_file=rsp_file, arf_file=arf_file, sum_channels=sum_channels)

        event_list = BinnedSpectrumSeries(spectrum_set, first_channel=0, verbose=verbose)
