...
def check_results(fit_results):
    ...
    assert np.isclose(fit_results['value']['bn090217206.spectrum.main.Powerlaw.K'],2.689, atol=1e-1)

    assert np.isclose(fit_results['value']['bn090217206.spectrum.main.Powerlaw.index'], -1.193, atol=5e-2)
