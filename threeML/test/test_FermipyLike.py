...
@skip_if_internet_is_not_available
@skip_if_fermipy_is_not_available
def test_FermipyLike_fromDisk_4FGL():
    from threeML.plugins.FermipyLike import FermipyLike
...
def test_FermipyLike_fromDisk_DR3():
    from threeML.plugins.FermipyLike import FermipyLike

    # Crab coordinates

    lat_catalog = FermiPySourceCatalog("4FGL-DR3")
    ...
    assert model.get_number_of_point_sources() == 169
    ...
    # However, let's free the index of the Crab
    #model.PSR_J0534p2200.spectrum.main.Super_cutoff_powerlaw_fermi.IndexS.free = True
    model.PSR_J0534p2200.spectrum.main.Super_cutoff_powerlaw.index.free = True
